...
@ Theory: This part was compiled with -O0, as most (if not all) functions has "mov r7, sp"
@ if thats true, then this code, sub_8002FEC.c and sub_800274C.c should all belong to the same file
...
_08002C4C: @ there are two functions in these bytes
	...
	.byte 0x02, 0xB0, 0x80, 0xBC, 0x02, 0xBC, 0x08, 0x47, /*Here ends sub_8002C4C*/ 0x90, 0xB5, 0x83, 0xB0, 0x6F, 0x46, 0x38, 0x60
	...
	.byte 0x62, 0x0A, 0x00, 0x03, 0x03, 0xB0, 0x90, 0xBC, 0x02, 0xBC, 0x08, 0x47 /*Here ends sub_8002CE8*/
